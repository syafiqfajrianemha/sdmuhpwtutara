...
if (isset($_POST['tambah'])) {
    ...
    header("Location: berita.php?sukses=inserted");
    exit;
}
...
if (isset($_POST['update'])) {
    ...
    header("Location: berita.php?sukses=updated");
    exit;
}
...
<div class="d-flex" id="wrapper">
  ...
  <div id="sidebar-wrapper" class="p-3">
    ...
    <div class="list-group list-group-flush">
      ...
      <a href="berita.php" class="list-group-item list-group-item-action <?= ($currentPage == 'berita.php') ? 'active-page' : '' ?>"><i class="fas fa-newspaper me-2"></i>Berita</a>
